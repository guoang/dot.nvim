...
-- 1. tkLink : the link title inside the brackets
-- 2. tkBrackets : the brackets surrounding the link title
-- 3. tkHighlight : ==highlighted== text (non-standard markdown)
-- 4. tkTag : well, tags
-- tkHighlight has nothing to do with links but I added it anyway, since I like highlighting text when taking notes 😄.

pcall(vim.cmd, "highlight link tkLink Blue")
pcall(vim.cmd, "highlight link tkBrackets Grey")
pcall(vim.cmd, "highlight link tkHighlight Orange")
pcall(vim.cmd, "highlight link tkTag Red")
